...
const Signup = () => {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      //   axios.get(`https://arjun-ictak.vercel.app/salman/studentCourse/${email}`)
      //   .then((res)=>{
  ...
  //     const result = await axios.post('https://arjun-ictak.vercel.app/salman/signup', { name, email, password, phone, batch });
  //     console.log(result);
  //     setSuccess('Signup successful! Redirecting to login...');
  //     setError('');
  //     console.log(success);
