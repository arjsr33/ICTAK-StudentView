...
const StudentDashboard = () => {
    ...
    useEffect(()=>{
        axios.get(`https://arjun-ictak.vercel.app/api/princy/studentCourse/${s_id}`)
        .then((res)=>{
    ...
    useEffect(()=>{
        axios.get(`https://arjun-ictak.vercel.app/api/princy/availableProjects/${studentData.s_course}`)
        .then((res)=>{
